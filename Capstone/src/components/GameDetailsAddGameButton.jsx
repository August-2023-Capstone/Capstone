...
const GameDetailsAddGameButton = ({ game }) => {
  ...
  return (
    <button
      ...
      className="bg-[#5a5a5a] hover:bg-[#666666] text-white font-bold py-1 px-3 rounded-sm text-lg mb-2"
      disabled={
...
GameDetailsAddGameButton.propTypes = {
  game: PropTypes.object.isRequired,
};

export default GameDetailsAddGameButton;
